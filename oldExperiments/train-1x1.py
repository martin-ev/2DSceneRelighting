...
while train_batches_counter < TRAIN_DURATION :
    ...
    if modulo == 0:
        with torch.no_grad():
            ...
            writer.add_scalar('Loss/3-G-Loss-Test', test_generator_loss/TESTING_BATCHES, step)
            writer.add_scalar('Loss/4-D-Loss-Test', test_discriminator_loss/TESTING_BATCHES, step)
